...
INSERT INTO streaks VALUES
    ...
    (2, 'user 02 goal 01', '300', 'this is how much i would have spent on cigarettes', 'day', '2018-03-01', '2018-04-28', 2, 1),
    (3, 'user 02 goal 02', '300', 'this is how much i would have spent on booze', 'week', '2018-02-01', '2018-03-20', 2, 2),
    (4, 'user 02 goal 02', '300', 'this is how much i would have spent on booze', 'week', '2017-12-01', '2017-12-20', 2, 2),
    (5, 'user 02 goal 03', '500', 'this is how much weight i have lost', 'week', '2018-01-01', '2018-04-11', 2, 3);
